...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000056b81cade6420e137824bdf221c663f05f0f24a4e25e38110b8f8f5a9c6"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1562562583, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "I am creating Coffee today 07/08/2019";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1562562583;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22044342;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000056b81cade6420e137824bdf221c663f05f0f24a4e25e38110b8f8f5a9c6"));
        assert(genesis.hashMerkleRoot == uint256("0xe53ccf41c140992fadb132ee1bbfb23fa96c6ee091b4570d83db768cd1508782"));

        // DNS Seeding
        //vSeeds.push_back(CDNSSeedData("", ""));
 

        // Coffee addresses start with 'M'
